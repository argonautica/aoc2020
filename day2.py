...
for j in temp:
  ...
  nums = l[0].split("-")
  c = l[1][:1]
  if l[2].count(c) <= int(nums[1]) and l[2].count(c) >= int(nums[0]):
    count += 1
print(count)
...
for j in temp:
  ...
  nums = l[0].split("-")
  c = l[1][:1]
  if(l[2][int(nums[1])-1] == c and l[2][int(nums[0])-1] != c) or (l[2][int(nums[0])-1] == c and l[2][int(nums[1])-1] != c):
    count += 1
print(count)

"""  if int(nums[2]) >= len(l[2]):
    if l[2][int(nums[1])] == c:
      count += 1
  elif (l[2][int(nums[1])] == c and l[2][int(nums[2])] != c) or (l[2][int(nums[2])] == c and l[2][int(nums[1])] != c):
    count += 1
"""